...
% In our problem, we have a planning period with each time period equal in time and work demands with multi-skill requirements
...
for the same period. In other words, it cannot be assigned for two overlappings (in time) demands.
