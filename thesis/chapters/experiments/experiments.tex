...
Heuristics like the max value are ones of the simpler heuristics to implement but often offer bad performance due to 
...
by this processing is gained back during the search. The earlier solutions are almost of the same quality but 
...
Propagation Guided relaxation takes a neighborhood size parameter, compare five values for this parameter:
