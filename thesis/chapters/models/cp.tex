...
\begin{enumerate*}[label=(\roman*)]
  ...
  \item the chosen worker for a variable is the most available for that demand but is also the least available for other demands.
\end{enumerate*}
...
We also make sure that if a variable is of size 2, it is always selected first to avoid having the fictitious value $\sigma$ assigned to it by 
propagation.
