...
class VillageOneMIPModelOld(problem: Problem) extends VillageOneModel(problem) {
...
object MipMain extends App {
  ...
  val model = new VillageOneMIPModelOld(JsonParser.parse("data/instances/problem.json"))
